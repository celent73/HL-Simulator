...
export const LegalModal: React.FC<LegalModalProps> = ({ isOpen, onClose, onAccept, type, mode }) => {
  ...
  const content = {
    ...
    terms: {
      ...
      text: (
        <div className="space-y-4">
          <p><strong>1. Accettazione dei Termini</strong><br />Utilizzando questa applicazione ("HL Simulator"), accetti di essere vincolato dai presenti Termini e Condizioni. Se non accetti, ti invitiamo a non utilizzare l'app.</p>
