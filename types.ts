...
export type HerbalifeLevel = 'Member' | 'Senior Consultant' | 'Success Builder' | 'Supervisor' | 'World Team' | 'Active World Team' | 'GET' | 'GET 2.5' | 'Millionaire' | 'Millionaire 7.5' | 'President';
